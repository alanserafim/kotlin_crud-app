...
class NavigationActivity : ComponentActivity() {
                    ...
                    content = { padding ->
                        Column(modifier = Modifier.padding(padding)) {
                            NavHost(navController, startDestination = BottomNavScreens.Cadastro.route) {
                                ...
                                composable(BottomNavScreens.Editar.route) { EditarScreen(this@NavigationActivity) }
                            }
                        }
                    }
                )
    ...
    @Composable
    fun CadastroScreen(viewModel: PessoaViewModel, navigationActivity: NavigationActivity) {
        ...
        //TextStyleNav(text = "Cadastro")
    }

    @Composable
    fun EditarScreen(navigationActivity: NavigationActivity) {
        //TextStyleNav(text = "Listagem")
